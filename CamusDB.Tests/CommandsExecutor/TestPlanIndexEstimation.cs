...
public sealed class TestPlanIndexEstimation : BaseTest
{
    ...
    public async Task AF5_CompositeIndex_RangeSelectivityUsesRangeColumn()
    {
        ...
        long rows = CostEstimator.EstimateRangeScanRows(node, 1_000, executor.Statistics, database, table);
    ...
    public async Task AF5_CompositeIndex_UpperOpenRange_SymmetricEstimate()
    {
        ...
        long upperOpenRows = CostEstimator.EstimateRangeScanRows(upperOpen, 1_000, executor.Statistics, database, table);
        long lowerOpenRows = CostEstimator.EstimateRangeScanRows(lowerOpen, 1_000, executor.Statistics, database, table);
