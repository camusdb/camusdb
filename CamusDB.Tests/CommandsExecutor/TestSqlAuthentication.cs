...
internal sealed class TestSqlAuthentication : BaseTest
{
    ...
    {
        Credential credential = PasswordHasher.Hash("app-password", Options.PasswordHashIterations);
        ...
        Credential second = PasswordHasher.Hash("app-password", Options.PasswordHashIterations);
