...
internal sealed class TestTableAlterer : SharedNodeBaseTest
{    
    ...
    public async Task TestCreateTableFillAndAddIndex()
    {
        ...
        // Indexes are owned by TableSchema.Indexes (the replicated source of truth),
    ...
    public async Task TestCreateTableFillRepeatedAndAddUniqueIndex()
    {
        ...
        // The aborted unique-index add must not leave a phantom in TableSchema.Indexes
