...
alter_table_stmt : TALTER TTABLE any_identifier TWADD any_identifier field_type { $$.n = new(NodeType.AlterTableAddColumn, $3.n, $6.n, null, null, null, null, null); }
                 | TALTER TTABLE any_identifier TWADD TCOLUMN any_identifier field_type { $$.n = new(NodeType.AlterTableAddColumn, $3.n, $6.n, null, null, null, null, null); }
                 | TALTER TTABLE any_identifier TWADD TCOLUMN any_identifier field_type create_table_constraint { $$.n = new(NodeType.AlterTableAddColumn, $3.n, $6.n, null, null, null, null, null); }
