...
public static class ConfigResolver
{
    ...
    public static CamusDBOptions Resolve(ConfigDefinition config)
    {
        ...
        ExpiredSessionRetentionMs = config.ExpiredSessionRetentionMs,
        ...
        LargeValueThresholdBytes = config.LargeValueThresholdBytes,
        LargeValueCompressionEnabled = config.LargeValueCompressionEnabled,
        LargeValueCompressionMinSavingPercent = config.LargeValueCompressionMinSavingPercent,
        LargeValueRewriteBatchRows = config.LargeValueRewriteBatchRows,
        LargeValueResolveBatchBytes = config.LargeValueResolveBatchBytes,
