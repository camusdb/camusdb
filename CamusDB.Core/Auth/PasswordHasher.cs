...
/// iteration count currently in force (<see cref="CamusDBOptions.PasswordHashIterations"/>).
...
public static class PasswordHasher
{
    ...
    /// <see cref="CamusDBConstants.MaxPasswordBytes"/> so an oversized input cannot turn one hash into a
    ...
    public static Credential Hash(string password, int iterations)
    {
        ...
        if (passwordBytes.Length > CamusDBConstants.MaxPasswordBytes)
